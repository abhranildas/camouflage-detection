function setUpExperiment_shape_exponent(exp_type,subjectStr)
    ...
    exponents=sort([linspace(0,2,7) [5 7 9]/6]);
%     exponents=[5 7 9]/6; 
...
%     [~,~,~,bdry_ribbon]=lib.circular_mask(bg_size,target_radius,'center',kernel_size);
    ...
    %% Session files
    ExpSettings = experiment.sessionSettings_shape_exponent(exp_type,texture_params, exponents, luminance, contrast, bg_size, target_radius, monitor_distance);
