function [coloured_noise_signal,white_noise_signal]=coloured_noise(sz,dim,exponent)
	...
	%
	% Example:
	% pink_noise=coloured_noise(1e3,1,-1)
	% [brown_noise_image,white_noise_image]=coloured_noise(300,2,-2)
	% blue_noise_cube=coloured_noise(100,3,1)
    % violet_noise_hypercube=coloured_noise(100,4,1)
	%
	% Inputs:
