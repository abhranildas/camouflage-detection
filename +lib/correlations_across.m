function [corr_cross,d,shift_stats_cross]=correlations_across(stim,mask)
% compute correlation coefficients of pairs of points in
% a stimulus image across the boundary (given by the mask).
...
% corr coeffs of 2 (x,y) pairs are computed to be inf. Make these nan.
corr_cross(isinf(corr_cross))=nan;