...
if exist('global_data/edges_bark.mat','file')==2
    load('global_data/edges_bark.mat')
...
%save('global_data/edges_bark.mat','edges','edge_powers','edge_ps','-v7.3')
...
% if exist('global_data/edge_measures.mat','file')==2
%     load('global_data/edge_measures.mat')
