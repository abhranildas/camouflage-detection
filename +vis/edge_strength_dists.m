...
%% ratio of across and along
histogram(seed_energy(:,5),'Normalization','pdf','LineStyle','none','FaceColor','r','FaceAlpha',.7)
hold on
histogram(seed_energy(:,2),'Normalization','pdf','LineStyle','none','FaceColor',[0 .45 .74],'FaceAlpha',.7)
