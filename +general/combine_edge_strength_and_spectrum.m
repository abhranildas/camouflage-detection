...
% Pink
load('global_data/edge_strengths.mat')
load('global_data/edge_spectra_LLR.mat','edge_spectra_LLR_pink')
...
% White
load('global_data/edge_strengths_whitened.mat')
load('global_data/edge_spectra_LLR.mat','edge_spectra_LLR_white')
