...
% if exist('vislab-common/data/seed_energy_pn_gradbynorm.mat','file')==2
%     load('vislab-common/data/seed_energy_pn_gradbynorm.mat')
...
% save('vislab-common/data/seed_energy_pn_gradbynorm.mat', 'seed_energy');
