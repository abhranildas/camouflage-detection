...
if exist('vislab-common/data/edge_powers_spots.mat','file')==2
    load('vislab-common/data/edge_powers_spots.mat')
...
input_img='vislab-common/data/spots.jpg';
...
save('vislab-common/data/edge_powers_spots.mat','edge_powers')